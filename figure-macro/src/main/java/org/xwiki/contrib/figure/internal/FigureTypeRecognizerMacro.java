...
public class FigureTypeRecognizerMacro extends AbstractNoParameterMacro
{
    ...
    /**
     * Parameter name for the figure style.
     *
     * @since 15.4
     */
    public static final String DATA_XWIKI_RENDERING_FIGURE_STYLE = "data-xwiki-rendering-figure-style";
    ...
    public List<Block> execute(Object parameters, String content, MacroTransformationContext context)
    {
        ...
        if (nextSibling instanceof FigureBlock && nextSibling.getParameter(DATA_XWIKI_RENDERING_FIGURE_TYPE) == null) {
            ...
            nextSibling.setParameter(DATA_XWIKI_RENDERING_FIGURE_STYLE,
                this.figureTypesConfiguration.getFigureStyle(type).getName());
        }
        return List.of();
    }
}
