...
public class FigureTypesConfigurationSource extends AbstractDocumentConfigurationSource
{
    /**
     * Hint of this component.
     */
    public static final String HINT = "XWiki.Figure.FigureTypesConfiguration";

    /**
     * Location of the figure types configurations.
     */
    public static final LocalDocumentReference DOCUMENT_REFERENCE =
        new LocalDocumentReference(List.of("XWiki", "Figure"), "FigureTypesConfiguration");
    ...
    {
        return "configuration.document.figure.types";
    }
}
